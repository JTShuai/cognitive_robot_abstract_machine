...
#
#   ./experiments/scripts/run_viz_demo.sh [apartment|kitchen] [local|web]
#   ./experiments/scripts/run_viz_demo.sh stop     # tear the container down
#
...
set -euo pipefail
CRAM_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
