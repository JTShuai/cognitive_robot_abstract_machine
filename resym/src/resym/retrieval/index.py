...
with weights fixed in the index configuration and frozen with the corpus
release. Retrieval is deterministic and LLM-free; every query
...
class RetrievalQuery:
    ...
    """
    Capability UIDs supported by the current CRAM robot and reviewed adapters.
    """
...
(:class:`~resym.retrieval.dense.DenseIndex`) provides, so only the query is ever encoded
at retrieval time.
"""
...
class RetrievalConfig:
    """
    Weights and hooks; frozen together with the corpus release.
    """
