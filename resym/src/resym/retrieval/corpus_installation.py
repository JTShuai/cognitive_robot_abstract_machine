...
it, and freezes it into a versioned retrieval release
(:mod:`resym.retrieval.freeze`). The frozen release must reproduce the pinned
fragment checksum, so every installation serves byte-identical corpus
content.
"""
...
"""
Default directory of the frozen retrieval release.
"""
...
def main() -> None:
    ...
    print(
        ...
        "uv run python -m resym.retrieval.dense"
    )
