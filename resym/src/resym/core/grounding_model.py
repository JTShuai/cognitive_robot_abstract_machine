...
class GroundingFactorySpec:
    ...
    supported_robot_types: tuple[str, ...] = ()
    """
    Compatible CRAM robot annotation classes; empty means robot-independent.
    """
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self, "supported_robot_types", tuple(self.supported_robot_types)
        )
        object.__setattr__(
            self,
